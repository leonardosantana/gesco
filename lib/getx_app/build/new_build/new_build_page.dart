...
class NewBuildPage extends StatelessWidget {
  ...
  Widget engineerField() {
    return Obx(() =>
        TextFormField(
            ...
            validator: (value) =>
            CommonValidator.validateEmail(value)
  ...
  Widget phaseField() {
    return Obx(() =>
        TextFormField(
            controller: controller.phaseController.value,
            decoration: const InputDecoration(
  ...
  Widget nameField() {
    return Obx(()=>
        TextFormField(
          ...
          validator: (value) =>
              CommonValidator.validateEmptyString(value)? 'Informe um nome para obra': null
        )
    );
  }
  ...
  TextFormField sizeField() {
    return TextFormField(
      ...
      validator: (value) =>
          CommonValidator.validateEmptyString(value)? 'Informe o tamanho da obra': null,
